...
import ReviewsCollected from '../Components/Reviews/ReviewsCollected/ReviewsCollected'
import SelectionSection from '../Components/Reviews/SelectionSection/SelectionSection'
...
const ReviewsPage = () => {
    ...
    const imageTile = (tile) => {
        return (
            <ImgTile
                media={tile.media_type}
                onClick={(e) => handleResults(tile)}
            >
                <img
        ...
        <Container>
            <Content>
                <SearchBar>
                    ...
                    ></input>
                    <button name="" onClick={(e) => handleSubmit(e)}>
                        Search
                    </button>
                </SearchBar>
                <ReviewsSection>
                    ...
                    {!reviewFound && (
                        <Images>
                            {results &&
                                results.map((result) => imageTile(result))}
                        </Images>
                    )}
